...
export const servicosMatriz: ServicoMatriz[] = [
  ...
  },
  {
    ...
    description: z => `Troca e substituição da fita de estores manuais em ${z}. Fita partida ou gasta? Serviço rápido ao domicílio, com deslocação gratuita na maior parte da Grande Lisboa. Orçamento gratuito.`,
    ...
    intro: z => `A fita do seu estore partiu ou está gasta em ${z.nome}? A Prime Estores faz a troca de fita de estores manuais ao domicílio em ${z.nome}, com rapidez e com deslocação gratuita na maior parte da Grande Lisboa. Levamos a fita adequada e substituímos no local.`,
  ...
  },
  {
    ...
    description: z => `Troca e substituição do motor de estores elétricos em ${z}. Motor queimado ou sem resposta? Serviço rápido ao domicílio, com deslocação gratuita na maior parte da Grande Lisboa. Orçamento gratuito.`,
