...
export const servicosMatrizEn: ServicoMatrizEn[] = [
  ...
  },
  {
    ...
    description: z => `Replacement of the strap of manual blinds in ${z}. Broken or worn strap? Fast home service, free call-out across most of Greater Lisbon. Free quote.`,
    ...
    intro: z => `Has your blind strap snapped or worn out in ${z.nome}? Prime Estores replaces the strap of manual blinds at your home in ${z.nome}, fast and with free call-out across most of Greater Lisbon. We bring the right strap and replace it on site.`,
  ...
  },
  {
    ...
    description: z => `Replacement of the motor of electric blinds in ${z}. Burnt-out or unresponsive motor? Fast home service, free call-out across most of Greater Lisbon. Free quote.`,
